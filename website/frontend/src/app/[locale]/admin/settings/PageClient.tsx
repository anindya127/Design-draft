...
const KEY_LABELS: Record<string, { label: string; help: string; type?: 'password' | 'text' }> = {
    ...
    PINGXX_WEBHOOK_SECRET:     { label: 'Webhook signing secret',      help: 'Ping++ dashboard → Webhooks → signing secret',                                      type: 'password' },
    PINGXX_PRIVATE_KEY:        { label: 'Private key (PEM)',           help: 'RSA private key for signing requests. Paste the full ---BEGIN---...---END--- block.', type: 'password' },
